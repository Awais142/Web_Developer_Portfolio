...
const About = () => {
  ...
  const technologies = {
    description: "I specialize in full-stack development with expertise in modern web technologies. My tech stack is carefully chosen to build scalable, performant, and user-friendly applications.",
    stack: [
              ...
              >
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-8 justify-items-center">
                  {technologies.stack.map((tech, index) => (
                    ...
                    >
                      <div className="w-16 h-16 flex items-center justify-center rounded-xl bg-black/20 backdrop-blur-sm border border-white/5 
