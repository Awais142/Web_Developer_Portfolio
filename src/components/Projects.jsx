  ...
  const projects = [
    {
      ...
      description:
        "MERN stack applicatin for creating professional resumes. Features include dynamic templates and real-time preview.",
    ...
    },
    {
      ...
      description:
        "Full-stack MERN application for job seekers and employers. Features include job posting, application tracking, and user authentication.",
      status: "Completed",
    ...
    },
    {
      ...
      description:
        "Modern e-commerce platform built with React and Fake Store API. Features product filtering, cart management, and responsive design.",
      status: "Completed",
    ...
    },
    {
      ...
      description:
        "Dynamic image search application using Unsplash API with infinite scroll and masonry layout.",
      status: "Completed",
    ...
    },
    {
      ...
      description:
        "Modern, animated portfolio website showcasing my projects and skills. Built with React, Vite, and Framer Motion for smooth animations.",
      status: "Completed",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-secondary text-lg max-w-3xl text-center mb-16">
            Here are some of my featured projects that demonstrate my skills and
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="absolute -inset-[1px] rounded-lg overflow-hidden bg-[#151030]">
                  {/* Starting point glow */}
                  <div
                    className="absolute top-0 left-1/2 w-2 h-2 bg-[#915eff] rounded-full
                    -translate-x-1/2 group-hover:opacity-100 opacity-0 transition-opacity duration-300"
                  />

                  {/* Right-moving beam */}
                  <div
                    className="absolute bg-gradient-to-r from-[#915eff] to-[#4d3483]
                    opacity-0 group-hover:opacity-100 group-hover:animate-beam-right"
                  />

                  {/* Left-moving beam */}
                  <div
                    className="absolute bg-gradient-to-l from-[#915eff] to-[#4d3483]
